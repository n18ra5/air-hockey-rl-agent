...
In the repository shown in the screenshot, run this file from anywhere with:

    python make_figures.py

Expected repository layout:

    3rewards_full_chaser/all_trial_results.csv
    balanced_ai_full_chaser/all_trial_results.csv
    assets/
    make_figures.py
...
# The current GitHub repository keeps make_figures.py in its root. Supporting
# the older analysis/ location as well makes the file easier to reorganise.
if SCRIPT_DIRECTORY.name == "analysis":
    REPOSITORY_ROOT = SCRIPT_DIRECTORY.parent
else:
    REPOSITORY_ROOT = SCRIPT_DIRECTORY

FIGURE_DIRECTORY = REPOSITORY_ROOT / "assets"
